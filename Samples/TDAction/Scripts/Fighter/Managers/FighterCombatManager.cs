...
{
    public class FighterCombatManager : CAF.Fighters.FighterCombatManager
    {
        public override CAF.Combat.MovesetDefinition CurrentMoveset { get { return (manager as FighterManager).entityDefinition.movesets[currentMoveset]; } }
        ...
        protected override bool CheckStickDirection(CAF.Input.InputDefinition sequenceInput, uint framesBack)
        {
